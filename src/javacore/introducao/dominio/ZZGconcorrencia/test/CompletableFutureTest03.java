...
import javacore.introducao.dominio.ZZGconcorrencia.service.StoreServiceDeprecated;
...
//        searchPricesAsyncFuture(storeService);
    ...
    private static void searchPricesAsyncCompletableFuture(StoreServiceDeprecated storeService) {
        ...
        List<CompletableFuture<Double>> completableFutures = stores.stream()
                .map(s -> CompletableFuture.supplyAsync(() -> storeService.getPrinceSync(s), executor))
